                ...
                override fun onDataChange(snapshot: DataSnapshot) {
                    if (snapshot.exists()) {
                        ...
                        userReference.updateChildren(updatedUserData).addOnSuccessListener {
                            Toast.makeText(this@ProfileInformationActivity, "Profile Update successfully", Toast.LENGTH_SHORT).show()
                            setResult(Activity.RESULT_OK)
                            finish()
                        }.addOnFailureListener {
                            Toast.makeText(this@ProfileInformationActivity, "Profile Update Failed", Toast.LENGTH_SHORT).show()
